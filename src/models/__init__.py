...
def get_model(conf, local_rank=-1, state_dict = None, bn_adv_flag=False, bn_adv_momentum=0.01):
    name = conf['model']
    ...
    if name == 'resnet50':
        ...
        model = WideResNet(28, 10, dropout_rate=0.0, num_classes=num_classes, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
